...
### <span id="Perl_is_hard">Perl is hard</span>
...
### <span id="Perl_looks_like_line_noise">Perl looks like line noise</span>
...
### <span id="Perl_is_hard_because_it_has_rege">Perl is hard because it has regexps</span>
...
### <span id="Perl_is_hard_because_it_has_refe">Perl is hard because it has references</span>
...
### <span id="Perl_is_just_for_Unix">Perl is just for Unix</span>
...
### <span id="Perl_is_just_for_one_liners_ca">Perl is just for one-liners - can't build \`real' programs with it.</span>
...
### <span id="Perl_is_just_for_CGI">Perl is just for CGI</span>
...
### <span id="Perl_is_too_slow">Perl is too slow</span>
...
### <span id="Perl_is_insecure">Perl is insecure</span>
...
### <span id="Perl_is_not_commercial_so_it_ca">Perl is not commercial, so it can't be any good</span>
