...
ActiveState extended the standard CPAN modules (Comprehensive Perl
...
Note the way commands are bound to the widgets. Whenever a user selects
...
We've looked at the pTk event model, a couple of the more common
