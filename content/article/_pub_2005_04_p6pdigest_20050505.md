{
   "slug" : "/pub/2005/04/p6pdigest/20050505",
   "tags" : [
      "compiler",
      "internals",
      "parrot",
...
BÃRTHÃZI AndrÃ¡s announced the release of the latest version of Memory.
...
Maybe I should have mentioned this first. Patrick R. Michaud released a
...
FranÃ§ois Perrad noticed a failure in `debuginfo`. Leo pointed out that
...
Ingo Blechschmidt wondered what `pick` would return when called on a
...
wondered if he could use lazy junctions. Thomas SandlaÃ conjectured that
