...
Now I knew what the data structure would be; but how would I store it?
...
The script shown above uses the
...
I reach into the `%data_for_ad_on` hash by specifying a key (the date of
