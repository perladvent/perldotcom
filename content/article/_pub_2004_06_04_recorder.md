...
For example, if you record filling in this form and clicking the Submit
button:
...
RT (Request Tracker) 3.1 by [Best Practical
...
The biggest challenge to writing a web recorder is knowing what the user
