...
Anyway, in PerlÂ 6 we're raising the standard for where we use
...
PerlÂ 6 has more different kinds of scopes, so we'll have more
...
For example, that's exactly what happened already with PerlÂ 5. We have
