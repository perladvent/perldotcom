...
*Jeffrey Ryan Thalhammer is the creator of [Perl::Critic]({{<mcpan "Perl::Critic" >}}), [Pinto]({{<mcpan "Pinto" >}}) and now [Stratopan](https://stratopan.com/) - a cloud based service that securely hosts custom repositories of Perl modules. We caught up with Jeffrey to get the latest Stratopan news and learn the tools, tricks and techniques he uses to code in Perl.*
