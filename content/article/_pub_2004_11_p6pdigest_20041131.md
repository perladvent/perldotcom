...
Joshua Gatcomb had a fairly long conversation with himself fleshing out
...
Stéphane Payrard asked about some problems he had encountered creating
...
no such type. This led to Stéphane Payrard asking about pmc\_type values
...
Jeff Clites noticed that *Makefile*'s `$(TOUCH)` does not actually work
