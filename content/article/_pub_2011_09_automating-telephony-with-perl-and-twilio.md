...
do many other interesting telephony things). Twilio’s RESTful API,
...
weather-by-SMS application, reminder by phone—anything, really—in
...
applications. I recommend starting with “How It Works” (one of the main
...
dependencies for you. If you’re leery of running code from a website
...
That’s the entire application. Run it, and if all went well, you should
...
… and then your phone should ring. I’ve always wondered how to pronounce
“plugh”—now I know.

**What could possibly go wrong?**
---------------------------------

Early on in Twilio development, you’re likely to experience a few little
gotchas. For example, you might get this message:

    LWP will support https URLs if the LWP::Protocol::https module
    is installed.

That’s LWP telling you to install
...
Notice the “401”? If you’re familiar with [HTTP status
codes](http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html), you
might remember that 401 means “Unauthorized”. You either didn’t present
...
Here’s a silly example of using the voicemail Twimlet to conduct a brief
phone survey and have the callee’s response transcribed and emailed.
