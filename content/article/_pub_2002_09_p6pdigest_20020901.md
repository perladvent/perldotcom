...
### <span id="dynamic_keys">Dynamic Keys</span>
...
### <span id="perl6_test_failures">Perl6 Test Failures</span>
...
### <span id="regex_status">Regex status</span>
...
### <span id="counting_down_to_0.0.8">Counting down to 0.0.8</span>
...
### <span id="an_'oops'_moment.">An 'Oops' Moment</span>
...
### <span id="various_changes_to_imcc">Various changes to IMCC</span>
...
### <span id="concatenation_failing">Concatenation Failing</span>
...
### <span id="irix64_alignment_problem">IRIX64 alignment problem</span>
...
### <span id="prototypes,_grammars_and_subs,_oh_my!">Prototypes, grammars and subs, oh my!</span>
...
### <span id="rule,_rx_and_sub">Rule, rx and sub</span>
...
### <span id="auto_deserialization">Auto deserialization</span>
...
### <span id="hypothetical_synonyms">Hypothetical synonyms</span>
...
[http://makeashorterlink.com/](http://makeashorterlink.com/?X15721DA1) -- Thread starts here, it's jolly good.

### <span id="does_:::_constrain_the_pattern_engine_implementation">Does ::: constrain the pattern engine implementation</span>
...
### <span id="backtracking_into_{_code_}">Backtracking into `{ code }`</span>
...
### <span id="prebinding_questions">Prebinding questions</span>
...
### <span id="regex_stuff">Regex stuff</span>
...
### <span id="the_news_from_london">The news from London</span>
...
### <span id="call_for_assistance">Call for assistance</span>
...
### <span id="squashing_a_myth">Squashing a myth</span>
...
Peter Gibbs offered a *huge* patch, merging his 'African Grey' parrot tweaks with the CVS parrot. It's not been applied in CVS, but [http://makeashorterlink.com/](http://makeashorterlink.com/?O1D741DA1) has the details.
