...
For more on the different types of ops available, how they fit together, and how to manipulate them with the `B` compiler module, look at the [Perl 5 internals tutorial](http://www.netthink.co.uk/downloads/internals). Right now, though, we're going to take things a step further.
