...
Additionally, for any use of the debugger, you should install the Perl modules [Term::ReadLine](http://search.cpan.org/perldoc?Term::ReadLine) and [Term::ReadKey](http://search.cpan.org/perldoc?Term::ReadKey) from [CPAN](http://www.cpan.org/). These will give you bash/csh-like cursor control, history browsing with up and down arrows, and tab completion on variables and functions.
...
[perldoc perldebtut](http://search.cpan.org/dist/perl/pod/perldebtut.pod)
