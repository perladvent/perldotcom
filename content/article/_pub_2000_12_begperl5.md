...
### <span id="what is an object">What Is an Object?</span>
...
### <span id="our goal">Our Goal</span>
...
### <span id="starting off">Starting Off</span>
...
### <span id="what does our object do">What Does Our Object Do?</span>
...
Fourth, we'll set a *property* called \`\`\_created''. This property isn't really that useful, but it does show the syntax for accessing the contents of an object: *$object\_name-&gt;{property\_name}*.
...
### <span id="our goal, part 2">Our Goal, Part 2</span>
...
These two methods are really all we need to begin experimenting with our `TutorialConfig` object. Take the module and sample configuration file from above (or [download the configuration file here](/media/_pub_2000_12_begperl5/tutc.txt) and [the module here](/media/_pub_2000_12_begperl5/TutorialConfig.pm)), put it in a file called `tutc.txt`, and then run [this simple program](/media/_pub_2000_12_begperl5/sample.pl):
...
-   [Complete `TutorialConfig.pm` module](/media/_pub_2000_12_begperl5/TutorialConfig.pm)
