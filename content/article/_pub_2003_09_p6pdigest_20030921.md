...
#### <span id="pondering argument passing">Pondering argument passing</span>
...
#### <span id="feature freeze for 0.0.11">Feature Freeze for 0.0.11</span>
...
#### <span id="some parrot people are disgustingly young">Some Parrot people are disgustingly young</span>
...
#### <span id="parrot musical chairs">Parrot musical chairs</span>
...
#### <span id="sorting out dependencies">Sorting out dependencies</span>
...
#### <span id="attaching debuggers">Attaching Debuggers</span>
...
#### <span id="various fixes">Various fixes</span>
...
#### <span id="parrot 0.0.11 doubloon released">Parrot 0.0.11 \`\`Doubloon'' Released</span>
...
#### <span id="disposable optimization">Disposable optimization</span>
...
-   Send feedback, flames, money, requests for consultancy, photographic and writing commissions, or a nice cup of tea to *<p6summarizer@bofh.org.uk>*
