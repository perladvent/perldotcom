...
As an example, the following code defines two options, `--run` and
...
To start with, the file format used by `Getopt::ArgvFile` is extremely
...
Now, create a settings file called *.hello* in your home directory
