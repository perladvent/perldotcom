...
At the same time, I was learning the wonders of the [Template Toolkit](/pub/a/2001/01/tt2.html), and thought that a well-designed blog should merely collect Post objects and send them to a user-defined template to do what it wants with them.
...
But as well as a linguist, I'm also a geek, and I use Perl to control various things around the house -- the house network, the division of the phone bill, and so on. This is all driven by Template Toolkit and [`Class::DBI`](/pub/a/2002/11/27/classdbi.html).
