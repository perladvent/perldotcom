...
diagram turned out to be have an omission â it does not handle blank
...
Figure 3 is a formal diagram of the final FSM, complete with blank-line
...
Not being an HTML expert, I initially tried to insert my sub-list
...
does the major work â scanning the current state's transition table to
see what to do next.
