...
Once an object is blessed, ref returns the name of its class instead. So
...
In Perl, you can set up a destructor for a class by defining a
...
Of course, these fundamental techniques only scratch the surface of
