...
### <span id="there is more than one world (in which) to do it">There Is More Than One World (In Which) To Do It</span>
...
### <span id="the entangle() function">The `entangle()` function</span>
...
### <span id="observation and collapse in perl">Observation and Collapse in Perl</span>
...
### <span id="entanglement and simple complex logic">Entanglement and Simple Complex Logic</span>
...
### <span id="complex amplitudes and entanglement in perl">Complex Amplitudes and Entanglement in Perl</span>
...
### <span id="beneath the veil">Beneath the Veil</span>
...
### <span id="objective reality">Objective Reality</span>
...
### <span id="when worlds collide">When Worlds Collide</span>
...
### <span id="london bridge is falling down">London Bridge is Falling Down</span>
...
### <span id="getting the module">Getting the Module</span>
