...
a discussion of the semantics of `[1,2,3] »+« [4,5,6]`{lang="und"
...
Then he scared me with `@foo »+= @foo`{lang="und" lang="und"}. He noted
that it might take some getting used to, but that it helped if you
pronounce `»`{lang="und" lang="und"} and `«`{lang="und" lang="und"} as
...
`«»`{lang="und" lang="und"} etc were the least of a syntax highlighters
...
on a list of values: `@list ».method`{lang="und" lang="und"}, and to
call a list of methods on a value: `$value.« @methods`{lang="und"
lang="und"}.

Then the fun began. The issue is that `»`{lang="und" lang="und"} and
`«`{lang="und" lang="und"} can also be written `<<`{lang="und"
...
parsed as `»+<<=«`{lang="und" lang="und"} or `»+«=«`{lang="und"
