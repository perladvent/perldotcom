{
   ...
   "slug" : "/pub/2004/08/p6pdigest/20040820",
   "categories" : "perl-6",
   "draft" : null,
   "thumbnail" : null,
...
### [The Perl 6 Summary for the fortnight ending 2004-08-20]{#The_Perl_6_Summary_for_the_fortnight_ending_2004-08-20}
...
#### [Register allocation]{#Register_allocation}
...
#### [Parrot cvs mirrored with svk]{#Parrot_cvs_mirrored_with_svk}
...
#### [The Pie-thon post-mortem]{#The_Pie-thon_post-mortem}
...
#### [An alternate call scheme]{#An_alternate_call_scheme}
...
#### [Source mangling slides]{#Source_mangling_slides}
...
#### [Making NCI work with a nasty library]{#Making_NCI_work_with_a_nasty_library}
...
#### [Functions for embedders to override]{#Functions_for_embedders_to_override}
...
#### [What Unicode means to us]{#What_Unicode_means_to_us}
...
#### [Fix generation of *src/nci.c* to be more efficient]{#Fix_generation_of_src/nci.c_to_be_more_efficient}
...
#### [The encoding API]{#The_encoding_API}
...
#### [COBOL on Parrot?]{#COBOL_on_Parrot?}
...
#### [The Perl 6 compiler pumpking]{#The_Perl_6_compiler_pumpking}
...
#### [Charset API]{#Charset_API}

Dan posted part two of the charset API, which confused me slightly by
arriving on my computer before Part 1.

<http://groups.google.com/groups?threadm=a06110410bd4148de4d94@%5B172.24.18.155%5D>
-- Part 1

<http://groups.google.com/groups?threadm=a06110400bd416568fe25@%5B172.24.10.164%5D>
-- Part 2

#### [Handling block parameters in Ruby]{#Handling_block_parameters_in_Ruby}
...
#### [Parakeet breaks and recovers]{#Parakeet_breaks_and_recovers}
...
### [NCI and callback functions]{#NCI_and_callback_functions}
...
#### [Popping an empty array]{#Popping_an_empty_array}
...
#### [Parrot interfaces]{#Parrot_interfaces}
...
#### [Interpreter permissioning]{#Interpreter_permissioning}
...
#### [Incremental garbage collection]{#Incremental_garbage_collection}
...
#### [Revision of Apocalypse 12's lookahead notions]{#Revision_of_Apocalypse_12's_lookahead_notions}
...
#### [Precedence table update]{#Precedence_table_update}
...
#### [Synopses drafts]{#Synopses_drafts}
...
#### [Return with no expression]{#Return_with_no_expression}
...
#### [`<->` as `->` with automatic `is rw`]{#<->_as_->_with_automatic_is_rw}
