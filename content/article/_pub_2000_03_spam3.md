...
Just reversing the order of the `foreach` loops speeds this up by a
...
The very next email message I received was titled `FYI`. It was from my
...
A lot of people wrote in about this, so it must work well for some
