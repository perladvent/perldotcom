...
#### [Parrot 0.0.9 status]{#parrot_0.0.9_status}
...
Leo Tötsch didn't like *nci.c*'s string functions, and wondered too
...
#### [Leopold Tötsch, still the patch monster]{#leopold_ttsch,_still_the_patch_monster}
