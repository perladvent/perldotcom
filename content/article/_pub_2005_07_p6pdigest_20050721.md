...
general, classes or roles. Thomas Sandlaß wondered how they stood in
relation to types.
...
Yuval Kogman discussed some issues with Software Transactional Memory
...
not the class `Foo` (or its subclasses) itself. Thomas Sandlaß thought
