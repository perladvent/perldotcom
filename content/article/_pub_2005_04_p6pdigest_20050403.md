...
Thomas SandlaÃ wondered if anyone would actually write S14 or if `does`
...
To follow up on his question about `does`, Thomas SandlaÃ wondered about
...
Palmer, and Thomas SandlaÃ delved into these mysteries.
...
FranÃ§ois Perrad provided a patch improving the documentation for
...
FranÃ§ois Perrad provided a patch fixing `MANIFEST.generated` for Win32.
Warnock applies.
...
FranÃ§ois Perrad fixed a test failure on MinGW. Leo applied it.
...
FranÃ§ois Perrad provided a patch that creates a standard binary
distribution for Win32. There was some debate over the name of the make
target, but FranÃ§ois is ready to send an updated version at Leo's
command.
