...
| Table of Contents                                                     |
+-----------------------------------------------------------------------+
| •[RFC 141: This Is The Last Major Revision](#rfc141)\                 |
| \                                                                     |
| •[RFC 28: Perl should stay Perl](#rfc28)\                             |
| \                                                                     |
| •[RFC 16: Keep default Perl free of constraints such as warnings and  |
| strict](#rfc16)\                                                      |
| \                                                                     |
| •[RFC 73: All Perl core functions should return objects](#rfc73)\     |
| \                                                                     |
| •[RFC 26: Named operators versus functions](#rfc26)\                  |
+-----------------------------------------------------------------------+
