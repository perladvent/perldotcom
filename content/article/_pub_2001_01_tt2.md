...
| Table of Contents                                                     |
+-----------------------------------------------------------------------+
| •[A more complex example](#a%20more%20complex%20example)\             |
| \                                                                     |
| •[Producing XML](#producing%20xml)\                                   |
| \                                                                     |
| •[Multiple Formats](#multiple%20formats)\                             |
+-----------------------------------------------------------------------+
...
TT2 was designed and written by Andy Wardley
...
Notice that as we've passed the whole object into `process` then we need
