...
From April 22-27, 2026, the invite-only [Perl Toolchain Summit](https://perltoolchainsummit.org/pts2026/) (PTS) brought together in Vienna, Austria, ~30 of the ecosystem’s most active maintainers — and welcomed 4 first-timers — for four days of uninterrupted deep-dive collaboration in pair-programming sessions, consensus discussions, and critical infrastructure work. Attendees tackled security tooling and infrastructure, modernization and redesign proposals, several CI and test harness improvements, Perl core optimizations, and metadata/spec updates.
...
### Security
CPANSec took it to another level, getting faster at discovering vulnerabilities (in modules, infra and core) and improving their process:
...
### Funding
Recent years made the topic of founding on the front of the stage. In particular to ensure sustainability of Perl maintenance funds, accelerate some initiatives (e.g. CPAN Security efforts) and financing community events (like this one!).

A lot of things happened on this front during the Perl Toolchain Summit:
 - A very strong effort towards founding security work
 - General discussions about founding of the community
 
### Group discussions
The Perl Toolchain Summit also gives the opportunity to interactions to the final benefit of strenghtening the toolchain.
Whether it's corridors discussions, small talks to know each others and build trust, discussions around a drink or group discussions (that led in the past to "consensus" or "amendment" papers).

During this PTS, there were particularly a lot of group discussions, maybe helped by having a dedicated meeting room.
...
### Podcast
As in 2025, PTS 2026 was a an opportunity to record new episodes for [underbar](https://underbar.cpan.io/):
 - configure
 - Vienna.pm
 - PPI
 - PSC
