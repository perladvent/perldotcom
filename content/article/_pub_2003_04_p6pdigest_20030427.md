...
Alberto SimÃµes continued on his mission to document Parrot's various PMC
...
#### [Leo TÃ¶tsch's iterator proposal]{#leo_ttsch's_iterator_proposal}

Remember Leo TÃ¶tsch's iterator proposal that received so little feedback
...
About a month ago, JÃ¼rgen BÃ¶mmels was doing some work on the moving
Parrot's IO operators to use Parrot's own PIO asynchronous IO system,
which broke Leon Brocard's *uniq.pasm*. JÃ¼rgen estimated that he might
