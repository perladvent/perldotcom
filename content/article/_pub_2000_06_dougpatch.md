...
In the normal case without inheritance, `Foo->bar()` will be subroutine
...
`method_named` is the op representing, unsurprisingly, a named method.
...
If it isn't a named method, (that is, if we've got something like
