...
`@objects».foo()`, which will try to call the method on *every* object
...
things like `%_«prim»` as proper parameter declarations. And that can
...
Unicode for small values of 6. (Not to be confused with ⁶, or ⅵ.)
