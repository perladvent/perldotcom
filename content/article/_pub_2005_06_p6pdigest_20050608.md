...
BÁRTHAZI András wondered about using rules in a web templating system he
...
but also thought it might been changed. Thomas Sandlaß agreed that it
had changed to:
...
BÁRTHAZI András wondered about the behavior of flattening arguments in
