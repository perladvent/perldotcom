...
and issue a request (for example <http://localhost/perl/setupenvoff.pl)>
for this script:
...
How expensive are those calls? Let's use the `Time::HiRes` module to
find out.
...
about 20 microseconds. So the average `stat()` system call is five times
