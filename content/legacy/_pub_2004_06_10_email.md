...
The classic Perl mail filtering tool is [`Mail::Audit`](http://search.cpan.org/perldoc?Mail::Audit), and I've written articles here about using Mail::Audit on its own (<http://www.perl.com/pub/2001/07/17/mailfiltering.html>) and using it in conjunction with [`Mail::SpamAssassin`](http://search.cpan.org/perldoc?Mail::SpamAssassin) (<http://www.perl.com/pub/2002/03/06/spam.html>).
