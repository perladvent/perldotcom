...
<p>But then along came the web, and "scripts" could be used to provide interactive web pages, and Perl became the darling language of the web, first with "cgi-lib.pl", and then with <a href="{{<mcpan "CGI">CGI</a>, and later with larger frameworks like <a href="http://www.masonhq.com">Mason</a> and <a href="http://www.catalystframework.org">Catalyst</a>.</p>
...
<p>On one hand new frameworks appeared (<a href="http://www.perldancer.org">Dancer</a>, <a href="http://mojolicio.us/">Mojolicious</a>, <a href="http://amon.64p.org/">Amon2</a>) and mature frameworks (<a href="http://www.catalystframework.org">Catalyst</a>) started supporting PSGI, and on the other hand web servers written entirely in Perl grew into existence, such as <a href="{{<mcpan "Starman">Starman</a>, <a href="https://metacpan.org/module/Twiggy">Twiggy</a>, <a href="https://metacpan.org/module/Corona">Corona</a>, and more.</p>
" >}}<hr />
</div>
