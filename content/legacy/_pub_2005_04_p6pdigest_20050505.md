...
Gaal Yahas proposed a basic `open` and `pipe` built-in for discussion. Discussion followed. Larry mentioned that he has "pretty much" blessed `io` (from [IO::All]({{<mcpan "IO::All" >}})).
