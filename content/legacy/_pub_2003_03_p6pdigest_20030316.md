{
   "slug" : "/pub/2003/03/p6pdigest/20030316.html",
...
#### <span id="parrot_0.0.10">Parrot 0.0.10</span>
...
[http://groups.google.com/groups](http://groups.google.com/groups?threadm=20030309225740.GA662%40foxglove) -- Feature freeze

[http://groups.google.com/groups](http://groups.google.com/groups?threadm=20030316091856.GB662%40foxglove) -- Release candidate announced

#### <span id="languages/basic_reorg">*languages/BASIC* reorg</span>
...
#### <span id="the_judy_algorithm">The Judy algorithm</span>
...
#### <span id="yet_another_iterator_proposal">Yet another iterator proposal</span>
...
#### <span id="parrot_for_windows">Parrot for Windows</span>
...
#### <span id="moving_to_pio">Moving to PIO</span>
...
#### <span id="imcc_and_pdd03_(calling_conventions)">IMCC and PDD03 (Calling conventions)</span>
...
#### <span id="parrot_extensions,_or_pmc_versatility">Parrot extensions, or PMC versatility</span>
...
#### <span id="sun4_vtable_jit_support">sun4 vtable JIT support</span>
...
#### <span id="a_fish,_a_barrel_and_a_running_joke">A fish, a barrel and a running joke</span>
...
#### <span id="parrot_reaches_another_milestone">Parrot reaches another milestone</span>
...
#### <span id="statement_modifiers">Statement modifiers</span>
...
#### <span id="just_when_you_get_fed_up_of_waiting_for_the_apocalypse...">Just when you get fed up of waiting for the Apocalypse...</span>
...
[http://www.perl.com/pub/2003/03/07/apocalypse6.html](/pub/2003/03/07/apocalypse6.html)
...
#### <span id="s&m_vs._b&d">S&M vs. B&D</span>
...
#### <span id="can_is_properties_be_specified_indirectly">Can "is" properties be specified indirectly?</span>
...
#### <span id="is_constant_eq_pass_by_value">`is constant` eq pass by value?</span>
...
#### <span id="complex_parameter_types">Complex Parameter Types</span>
...
[http://groups.google.com/groups](http://groups.google.com/groups?threadm=20030314033648.58654.qmail%40onion.perl.org) -- the inference subthread

[http://groups.google.com/groups](http://groups.google.com/groups?threadm=20030313195506.GA15015%40wall.org) -- My head hurts

#### <span id="signatures_zones_and_line_noise">Signatures zones and line noise</span>
...
#### <span id="in_which_luke_palmer_gets_ignored">In which Luke Palmer gets ignored</span>
...
[http://groups.google.com/groups](http://groups.google.com/groups?threadm=ygc1y1eictl.fsf%40babylonia.flatirons.org) -- temp/let

[http://groups.google.com/groups](http://groups.google.com/groups?threadm=ygcsmtu5h0l.fsf%40babylonia.flatirons.org) -- Continuations

#### <span id="multi_promotion">Multi promotion</span>
...
[http://groups.google.com/groups](http://groups.google.com/groups?threadm=3E6E853D.9090604%40conway.org) -- Dispatch rules (OK?)

#### <span id="wrappers_vs._efficiency">Wrappers vs. Efficiency</span>
...
#### <span id="macro_invocants">Macro invocants</span>
...
#### <span id="overloading_multis_on_constness_of_parameters">Overloading multis on constness of parameters</span>
...
[http://groups.google.com/groups](http://groups.google.com/groups?threadm=20030314205347.31744.qmail%40web12308.mail.yahoo.com) -- Austin's chart

#### <span id="operators_and_context">Operators and context</span>
...
#### <span id="assignment_overloading">Assignment Overloading</span>
...
[http://groups.google.com/groups](http://groups.google.com/groups?threadm=20030314184631.GD22246%40wall.org) -- Larry on types and classes

#### <span id="thoughts_about_multiple_properties">Thoughts about multiple properties</span>
...
#### <span id="no_mandatory_named_arguments">No mandatory named arguments?</span>
...
-   Send feedback, flames, money, job offers or a 'get out of war free' card to *<p6summarizer@bofh.org.uk>*
