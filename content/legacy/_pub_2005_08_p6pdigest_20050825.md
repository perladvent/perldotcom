...
Autrijus (while discussing type inference in Perl 6) recalled that there was a Google Summer of Code project on [type inferencing in Perl 5]({{<mcpan "Devel::TypeCheck" >}}). Gary Jackson, the summer coder, provide a more detailed description of his work.
