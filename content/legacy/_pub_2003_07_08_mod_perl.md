...
Of course, no module would be complete without a test suite, and the [Apache-Test](https://metacpan.org/search?q=query=Apache-Test) framework introduced [last time](/pub/2003/05/22/testing.html) gives us all the tools we need to write a complete set of tests.
