...
The Perl module `Tie::File` allows us to do so in a particularly convenient fashion: it `tie`s a Perl array to the file in such a way that each record corresponds to an element of the array.
