...
Jeff Clites noticed that *Makefile*'s `$(TOUCH)` does not actually work on many platforms and suggested a solution. Michael G. Schwern suggested using [ExtUtils::Command]({{<mcpan "ExtUtils::Command" >}}) instead. Who knows what will finally happen?
