...
#### <span id="Unifying_call_and_return">Unifying call and return</span>
...
#### <span id="Reviewing_a_book_about_VMs">Reviewing a book about VMs</span>
...
#### <span id="IMCC_gets_high_level_sub_call_syntax">IMCC gets high level sub call syntax</span>
...
#### <span id="IMCC_problems_with_library_loading">IMCC problems with library loading</span>
...
#### <span id="A_new_list_proposal">A new list proposal</span>
...
#### <span id="Parrot_Documentation_Review">Parrot Documentation Review</span>
...
#### <span id="Freeze_is_in">Freeze is in</span>
...
#### <span id="Warning_Patrol">Warning Patrol</span>
...
#### <span id="Finished/stable_parts_of_Parrot?">Finished/stable parts of Parrot?</span>
...
#### <span id="Do_Steve_Fink's_debugging_for_him">Do Steve Fink's debugging for him</span>
...
#### <span id="Another_minor_tasks_for_the_interested">Another minor tasks for the interested</span>
...
#### <span id="Bytecode_portability_and_word/int_sizes">Bytecode portability and word/int sizes</span>
...
#### <span id="Fun_with_'multi'">Fun with 'multi'</span>
...
#### <span id="The_Perl_6_design_process">The Perl 6 design process</span>
...
#### <span id="Control_flow_variables">Control flow variables</span>
...
#### <span id="s///_in_string_context_should_return_the_string">`s///` in string context should return the string</span>
...
If you find these summaries useful or enjoyable you might like to show your appreciation by contributing money or time to the Perl Foundation and the Perl 6 effort. , or you could give me feedback directly at [p6summarizer@bofh.org.uk](mailto:p6summarizer@bofh.org.uk), or stop by at my website.
