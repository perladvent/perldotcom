...
Other functions and features are documented in the Test::More documentation. As well, [Test::Tutorial]({{<mcpan "Test::Tutorial" >}}) explains similar things with a different wit.
...
One goal of Perl is to make your life easier. Perl 5.8 will include [Test::More]({{<mcpan "Test::More" >}}) and its hearty brethren, [Test::Simple]({{<mcpan "Test::Simple" >}}) and [Test::Builder]({{<mcpan "Test::Builder" >}}). They exist to make writing tests less of a hassle, and even more pleasant. Consider them.
